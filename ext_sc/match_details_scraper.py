...
if __name__ == "__main__":
    ...
    try:
        ...
        if connection.is_connected():
            ...
            cursor.execute(
                "SELECT id,bolddk_match_id FROM `sports_footballmatch` WHERE parsed_match_date_time > NOW() OR parsed_match_date_time IS NULL")
            ...
            for match in matches:
                ...
                if response.status_code == 200:
                    ...
                    `league_country` = %s
                    WHERE id = %s """
                    cursor.execute(sql, (match_date, match_time, match_date, league_id, home_team_id, away_team_id,
